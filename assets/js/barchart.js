...
const url =
  "https://u230654.gluwebsite.nl/infographic/assets/data/barchart.json";

const url2 = "http://localhost/infographic/assets/data/barchart.json";
...
xmlhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    data = data.languages;
    data = sortArrayOfObjects(data, "experience", "descending");
    setBarchart(data);
  }
};
...
function setBarchart(data) {
  ...
  new Chart(canvas, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Most sold games in units (millions)",
          data: experiences,
